...
- ⚙️ **Agent Configuration**: Add, configure, and health-check multiple AI agents
...
npm run dev:electron  # 🖥️ Electron app
```
...
| ⚙️ **AgentModal** | Configure and manage agents |
...
- 🖥️ **Electron**: Window management and file system access
